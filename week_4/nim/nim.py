...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        for value in self.q:
            if value[0] == tuple(state) and value[1] == action:
                return self.q[value]
        return 0 
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if epsilon == False:
            ...
            for action in actions:
                if best_action == None or self.get_q_value(state, action) > best_value:
            ...
            if random.random() <= epsilon:
                ...
                for item in available:
                    available2.append(item)
                amount_available = len(available2)
                
                choise = random.randint(0, amount_available-1)
                return available2[choise]
